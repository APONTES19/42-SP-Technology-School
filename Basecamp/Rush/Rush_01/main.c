...
[] - Cada uma das vistas (duas por linha e duas por coluna) terá um valor dado,
de 1
...
[x] - Em caso de erro você deve escrever somente "Error" seguido de uma quebra
de linha.

[x] - Verificar se o jogo é válido somando as arestas topo = 9 e lados =
8 para 4x4
...
Como bônus, você pode fazer um programa que resolva tabuleiros de
tamanhos diferentes, como 3x3, 5x5, etc.
...
Italo | itaureli quem escreveu o codcódigo assim. 
*/